...
<form method="post" action="{{route('employee.update', ['employee' => $employee])}}">
  @csrf
  @method('put')
<h4>Employee {{$employee->employee_id}}'s Profile</h4>
...
<div class="grid row gx-6">
  <div class="col-md-4">
    <label class="form-label" for="validationCustom02">Sex</label>
      <input class="form-control" id="validationCustom02" name="sex" type="text"value="{{$employee->sex}}" required="" data-bs-original-title="" title="" ReadOnly>
  </div>
  <div class="col-md-4">
